...
# Sigmoid SVM
My_Model = svm.SVC(kernel='sigmoid', C=1.0)
My_Model.fit(X_train,Y_train.ravel())
y_pred = My_Model.predict(X_test)
print('Accuracy of a Sigmoid SVM is: ', metrics.accuracy_score(Y_test, y_pred))

#K-fold cross validation
Validation_of_Model = cross_val_score(My_Model,normalized_Features,my_class.ravel(), cv= 10)
print('Accuracy of our model using 10-fold validation is: ',Validation_of_Model.mean())
