...
#KNN. Looping to find best K
for n in range(1, 50):
    My_Model = neighbors.KNeighborsClassifier(n_neighbors=n)
    ...
    print('With K = ', n ,' : Accuracy of our model using 10-fold validation is: ',model_scores.mean())
